...
var italic = 'font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; color: #f9dea6; font-size: 16px; padding: 10px 20px; background: #030307; line-height: 1; text-shadow: 0 1px #000';
var bold = 'font-style: italic; font-weight: bold';
log.l('%c了解 Andy%c %chttp://baby925.top/andyBlog/%c', italic, '', bold, '');
